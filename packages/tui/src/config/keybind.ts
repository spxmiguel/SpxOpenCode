...
export const Definitions = {
  ...
  command_list: keybind(["ctrl+p", "super+p"], "List available commands"),
  ...
  sidebar_toggle: keybind(["<leader>b", "super+b"], "Toggle sidebar"),
  ...
  session_new: keybind(["<leader>n", "super+n"], "Create a new session"),
  session_list: keybind(["<leader>l", "super+l"], "List all sessions"),
  ...
  model_list: keybind(["<leader>m", "super+m"], "List available models"),
  ...
  agent_cycle_reverse: keybind("<leader>A", "Previous agent"),
  spx_accept_cycle: keybind("shift+tab", "Cycle accept mode (Manual/Auto/YOLO)"),
  ...
  messages_copy: keybind(["<leader>y", "super+c"], "Copy message"),
  ...
  input_paste: keybind([{ key: "ctrl+v", preventDefault: false }, { key: "super+v", preventDefault: false }], "Paste from clipboard"),
  input_submit: keybind(["return", "super+return"], "Submit input"),
  ...
  input_delete_to_line_end: keybind(["ctrl+k", "super+k"], "Delete to end of line in input"),
...
export const CommandMap = {
  ...
  spx_accept_cycle: "spx.accept.cycle",
